...
public abstract class Bot extends ListenerAdapter{
	...
	/**
	 * Prefijo del bot. Se usa por defecto en todos los servidores({@link com.jaxsandwich.framework.models.discord.ConfigGuild}) en los cuales no se ha especificado un prefijo.
	 * Bot prefix. Is used as defaultin all the guilds({@link com.jaxsandwich.framework.models.discord.ConfigGuild}) which doesn't have a specific prefix).
	 */
	protected String prefix = ">";
	/**
	 * Prefijo de opción del bot. Se usa por defecto en todos los servidores({@link com.jaxsandwich.framework.models.discord.ConfigGuild}) en los cuales no se ha especificado un prefijo de opción.
	 * Bot option prefix. Is used as default in all the guilds({@link com.jaxsandwich.framework.models.discord.ConfigGuild}) which doesn't have a specific option prefix).
	 */
	protected String opt_prefix = "-";
	/**
	 * Indica si el bot esta encendido o apagado (enendido = escuchando comandos). Las categorías 'especiales' ({@link com.jaxsandwich.framework.annotations.Category}(special=true)) pueden ser escuchadas sin importar el estado de este atributo.
	 * Indicates if the bot is on or off (on = listenning to commands). The 'special' categories ({@link com.jaxsandwich.framework.annotations.Category}(special=true)) can be executed no matter the value of this attribute.
	 * */
	...
	/**
	 * Gestor de comandos extra({@link com.jaxsandwich.framework.models.ModelExtraCommand}) del bot.
	 * Manager of extra command({@link com.jaxsandwich.framework.models.ModelExtraCommand}) of the bot.
	 */
	...
	/**
	 * Analiza el evento({@link MessageReceivedEvent}) y ejecuta el comando({@link com.jaxsandwich.framework.models.ModelCommand}) si esta presente.
	 * Analyzes the event({@link MessageReceivedEvent}) and executes the commad({@link com.jaxsandwich.framework.models.ModelCommand}) if it's present.
	 */

...
public class CommandPacketBuilder {
	...
	/**
	 * {@link ConfigGuild} asociado al paquete si el {@link MessageReceivedEvent} proviene de un servidor.
	 * {@link ConfigGuild} associated to the packet if the {@link MessageReceivedEvent} is from a guild.
	 */
	private ConfigGuild guild = null;
	/**
	...
	/**
	 * Argumentos a usar en un {@link  com.jaxsandwich.framework.models.ModelExtraCommand}. Solo disponible para {@link ExtraCmdPacket}.
	 * Arguments used for a {@link  com.jaxsandwich.framework.models.ModelExtraCommand}. Only available for {@link ExtraCmdPacket}.
	 */
	private Object[] args;
	/**
	 * Argumentos a usar en un {@link  com.jaxsandwich.framework.models.ModelExtraCommand} mientras esta en espera. Solo disponible para {@link ExtraCmdPacket}.
	 * Arguments used for a {@link  com.jaxsandwich.framework.models.ModelExtraCommand} while it's waiting. Only available for {@link ExtraCmdPacket}.
	 */
	private Object[] eachArgs = null;
	/**
	 * Argumentos a usar en un {@link  com.jaxsandwich.framework.models.ModelExtraCommand} después de la ejecucion exitosa. Solo disponible para {@link ExtraCmdPacket}.
	 * Arguments used for a {@link  com.jaxsandwich.framework.models.ModelExtraCommand} after a successful execution. Only available for {@link ExtraCmdPacket}.
	 */
	private Object[] afterArgs = null;
	/**
	 * Argumentos a usar en un {@link  com.jaxsandwich.framework.models.ModelExtraCommand} cuando no fue jecutado. Solo disponible para {@link ExtraCmdPacket}.
	 * Arguments used for a {@link  com.jaxsandwich.framework.models.ModelExtraCommand} when it's not executed. Only available for {@link ExtraCmdPacket}.
	 */
	private Object[] noArgs = null;
	/**
	 * Argumentos a usar en un {@link  com.jaxsandwich.framework.models.ModelExtraCommand} se haya ejecutado o no. Solo disponible para {@link ExtraCmdPacket}.
	 * Arguments used for a {@link  com.jaxsandwich.framework.models.ModelExtraCommand} if it's been executed or not. Only available for {@link ExtraCmdPacket}.
	 */
	 ...
	 */
	public CommandPacketBuilder(Bot bot, ConfigGuild guild, MessageChannel channel, String authorId) {
		this.bot=bot;
		this.guild=guild;
	...
	/**
	 * Devuelve el {@link ConfigGuild} de este CommandPacketBuilder.
	 * Returns the {@link ConfigGuild} of this CommandPacketBuilder.
	 */
	public ConfigGuild getGuild() {
		return guild;
	}
	/**
	 * Configura el {@link ConfigGuild} de este CommandPacketBuilder.
	 * Sets the {@link ConfigGuild} of this CommandPacketBuilder.
	 */
	public void setGuild(ConfigGuild guild) {
		this.guild = guild;
	}
	/**

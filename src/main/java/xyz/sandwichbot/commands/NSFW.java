...
public class NSFW {
	...
	@Option(name="cantidad",desc="Indica la cantidad de imagenes que devolverá el comando. DEBE SER UN VALOR NUMÉRICO ENTRE 1 Y 100 (se que quieres más, pero tu mano se va a hacer mierda). Si ingresas mal este número te quedarás sin placer:smirk:",alias={"c","cant","num"})

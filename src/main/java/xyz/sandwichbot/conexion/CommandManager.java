...
public class CommandManager {
	...
	public static boolean insert(Object objeto, boolean autoId) throws Exception {
		...
		for(Field f : flds) {
			...
			if(f.getDeclaredAnnotation(PrimaryKey.class) != null && autoId) {
				o="null";
			}
			if(o==null)
				o="null";

...
public class VideoJuegos {
	@Command(name="Lol",enabled=true)
	@Option(name="perfil",desc="Muestra información del invocador. Se requiere especificar una región. Si no se especifica por defecto es 'LAS'.",alias={"stats","p"})
	@Option(name="region",desc="Especifica la región. Contexto necesario para el comando. Regiones disponibles:\n`LAS`, `LAN`, `NA`, `EUNE`, `EUW`, `BR`, `OCE`, `KR`, `RU`, `TR` y `JP`\nSi no se especifica `LAS` se usa por defecto.",alias={"r"})
	@Option(name="jugando",desc="Muestra información de la partida actual del invocador(si este se encuentra en una). Se requiere especificar una región. Si no se especifica por defecto es 'LAS'.",alias={"j"},enabled=false)

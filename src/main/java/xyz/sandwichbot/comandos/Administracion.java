...
public class Administracion {
	...
	@Command(name="Configurar",enabled=true)
	@Option(name="?",desc="Explicación y ejemplos de uso de los comandos de la configuración.")
	@Option(name="prefijo",desc="Personaliza el prefijo en este servidor.",alias={"p"})
	@Option(name="opcion",desc="Personaliza el prefijo de parametros/opciones en este servidor.",alias={"o","op"})
	@Option(name="idioma",desc="Configura el idioma del bot. Solo conozco dos idiomas: Español[ES] e Inglés[EN].",alias={"i","l"})
	@Option(name="bloquear",desc="Bloquea al objetivo en este servidor.\nSi el objetivo es un comando/categoría este no podrá ser usado en este servidor.\nSi el objetivo es un miembro/rol este no podrá usar comandos en este servidor.\nSi el objetivo es un canal en este no se podrán usar comandos.\n`El objetivo debe ser etiquetado(Canal, Miembro y Rol), excepto si este es un comando o una categoría.`",alias={"b","blq"})
	@Option(name="desbloquear",desc="Desbloquea al objetivo en este servidor.\nSi el objetivo es un comando/categoría este podrá ser usado en este servidor.\nSi el objetivo es un miembro/rol este podrá usar comandos en este servidor.\nSi el objetivo es un canal en este se podrán usar comandos.\n`El objetivo debe ser etiquetado(Canal, Miembro y Rol), excepto si este es un comando o una categoría.`",alias={"d","dsbl"})
	@Option(name="comandos",desc="Esta opción habilita el menú de configuración de los comandos en este servidor.",alias= {"cmd","cmds"},enabled=false)
	@Option(name="bot",desc="Esta opción habilita el menú de configuración del bot en este servidor.",alias= {"jax","sandwich"},enabled=false)
	@Option(name="censura",desc="Esta opción habilita el menú de configuración del control de contenido en este servidor.",enabled=false)
	@Option(name="alarmas",desc="Esta opción habilita el menú de configuración de alarmas en este servidor.",enabled=false)
